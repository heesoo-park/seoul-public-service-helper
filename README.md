...
🎇 Clean Architecture의 구조와 흐름 파악 및 앱 적용   
👍 프로젝트에 Clean Architecture를 적용해보면서 해당 아키텍처가 확실히 경계를 나눔으로써 의존성을 낮춰, 유지보수에 큰 이점이 있다는 것을 깨닫게 되었습니다. 적용하는 것이 쉽지 않았고, 아직까지는 미흡하지만 새로운 것을 함께 공부하고 적용해보는 시간을 가져봄으로써 개발에 필요한 역량을 습득할 수 있었습니다.
