...
## 📌 주요 기능
#### ✔ 서울시 공공서비스 예약 정보 확인
- 앱 내의 여러 페이지에서 예약에 관련된 정보를 얻을 수 있음
    - 요금, 서비스 대상, 예약 일자, 시간, 장소 등등
- 전화나 외부 웹 사이트로 이동 가능
#### ✔ 관심 지역별 공공서비스 탐색
- 서울 지역구 중에서 최대 3개까지 관심 지역을 선택하여 메인 페이지에서 전환 가능
- 선택한 지역에 존재하는 공공서비스가 카테고리별로 나눠져있어 편하게 탐색 가능
- 키워드 검색을 통해서도 탐색 가능
#### ✔ 지도를 이용한 공공서비스 탐색
...
## 📌 사용기술
![image](https://github.com/heesoo-park/seoul-public-service-helper/assets/80674868/58a99f56-6787-4082-aefe-686079ffada6)
